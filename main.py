...
<details>
  ...
  <details>
    ...
    <p>まず、著作権法の基本的な考え方についてご説明します。
    著作権法第1条（目的）には、著作物の公正な利用に留意しつつ、著作者等の権利の保護を図ることで、新たな創作活動を促し、文化の発展に寄与することが目的とされています。
そのため、著作権法では、著作者等の権利利益を保護することと、著作物を円滑に利用できること、この両者のバランスを取ることが重要と考えられています。
各種の規定もこの考え方に基づいて制度設計されています。AIと著作権の関係を理解する上でも、この基本的な考え方は重要ですので、ぜひ覚えておいてください。</p>
    <details>
      <summary>2. 著作権法が保護する対象</summary>
      <p>著作権法は、著作物を保護するものです。では、著作物とは何か。著作権法では、「思想または感情を創作的に表現したものであって、文芸、学術、美術または音楽の範囲に属するもの」と定義されています。

この定義から外れる、例えば単なるデータ、事実、ありふれた表現、表現とは言えないアイデアにあたる作風や画風などは、著作権法による保護の対象には含まれません。つまり、一つの作品の中でも、著作物性のある部分（著作権で保護される部分）と、著作物性のない部分が存在しているということです。

アイデアは著作物に当たらず、著作権法上は保護されません。これは、著作権の権利の性質と関係しています。著作物に当たる場合、著作権者はその利用を独占できます。その保護期間は、創作されてから著作者の死後70年が経過するまで及びます。

アイデアを著作権法で保護してしまうと、保護の程度が強すぎ、後発の新たな創作や表現活動を妨げてしまう恐れがあります。そのため、アイデアは自由に利用させた方が、創作や表現の多様化・豊富化につながると考えられています。</p>
    </details>
    <details>
          <summary>3. 著作権・著作権者とは</summary>
          <p>著作者とは、「著作物を創作する者」と規定されています。後ほど改めて触れますが、AIを使ってコンテンツを生成した場合、この「創作する者」が誰なのかを検討する必要があります。
    ...
    <details>
      ...
      <details>
              <summary>5.著作権侵害の要件</summary>
                  ...
                  著作権侵害の要件として、裁判例では以下の2つの要件を満たすことが必要とされています：
                  <br>●類似性：後発の作品が既存の著作物と同一または類似していること。
                  <br>●依拠性：既存の著作物に依拠して複製等がされたこと。
